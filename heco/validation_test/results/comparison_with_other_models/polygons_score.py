...
# ── File paths ────────────────────────────────────────────────────────────────
PROJECTED_CRS = "EPSG:32620" #UTM 20 N with WGS84

OBS_PATH = Path("OpenOil_2570435-rId75_UTM20N_polygon_OBSERVED.geojson")
# SIM_PATH = Path("results/qgis_comparison/convex-hull-polygon-TEST-2-2021-08-30_10-36.geojson")
SIM_PATH = Path("OpenOil_2570435-rId75_UTM20N_polygon_PREDICTED.geojson")
